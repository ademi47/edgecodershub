...
export default function BookingSystem() {
    ...
    const N8N_BASE_URL = 'https://n8n.edgecodershub.com/webhook-test/booking-create';
    ...
    const loadData = async () => {
        try {
            ...
            if (bookingsData.bookings) {
                // Transform Google Sheets data to booking objects
                const transformedBookings = bookingsData.bookings.map((row: any[]) => ({
                    id: row[0],
                    name: row[1],
                    email: row[2],
                    phone: row[3],
  ...
  const newBooking: Booking = {
    ...
    createdAt: new Date().toISOString()
     ...
     // Send to n8n (which will save to Google Sheets and send email)
  await fetch(`${N8N_BASE_URL}/booking-create`, {
    method: 'POST',
